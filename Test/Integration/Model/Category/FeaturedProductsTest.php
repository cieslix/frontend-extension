...
namespace Creativestyle\FrontendExtension\Test\Integration\Model\Category;
...
class FeaturedProductsTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->categoryHelper = $this->objectManager->get(\Creativestyle\FrontendExtension\Helper\Category::class);
    }
