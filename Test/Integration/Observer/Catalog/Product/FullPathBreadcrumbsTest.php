...
namespace Creativestyle\FrontendExtension\Test\Integration\Observer\Catalog\Product;
...
class FullPathBreadcrumbsTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Creativestyle\FrontendExtension\Service\Breadcrumb\BreadcrumbCategoryFinderInterface
     */
    ...
    public function setUp()
    {
        ...
        $this->categoryFinder = $this->objectManager->get(\Creativestyle\FrontendExtension\Service\Breadcrumb\BreadcrumbCategoryFinderInterface::class);
    ...
    public function testCurrentCategoryIsFilledWithFirstFoundCategory($sku, $expectedCategoryId) {
        if(get_class($this->categoryFinder) != \Creativestyle\FrontendExtension\Service\Breadcrumb\FirstCategoryFinder::class) {
