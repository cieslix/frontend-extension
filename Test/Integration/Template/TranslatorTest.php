...
class TranslatorTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Creativestyle\FrontendExtension\Template\Translator
     */
    private $translator;
    ...
    public function setUp()
    {
        ...
        $this->translator = $this->objectManager->get(\Creativestyle\FrontendExtension\Template\Translator::class);
