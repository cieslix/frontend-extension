...
namespace Creativestyle\FrontendExtension\Test\Integration\Setup;
...
class AttributeTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testItFindsAttributes()
    {
        ...
        $this->assertNotEmpty($eavSetup->getAttributeId(\Magento\Catalog\Model\Category::ENTITY, 'show_in_brand_carousel'));
