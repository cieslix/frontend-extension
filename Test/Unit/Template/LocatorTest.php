...
namespace Creativestyle\FrontendExtension\Test\Unit\Template;
...
class LocatorTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function getLocator() {
        ...
        return new \Creativestyle\FrontendExtension\Template\Locator($resolverDummy, $stateDummy, $this->designStub, $this->customizationPathStub);
    }
}