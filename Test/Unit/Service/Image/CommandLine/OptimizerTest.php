...
namespace Creativestyle\FrontendExtension\Test\Unit\Service\Image\CommandLine;
...
class OptimizerTest extends \PHPUnit\Framework\TestCase
{
    public function testItUsesOptimizerLibraryCorrectly()
    {
        ...
        $consoleOptimizer = new \Creativestyle\FrontendExtension\Service\Image\CommandLine\Optimizer($optimizerFactoryStub);
