...
namespace Creativestyle\FrontendExtension\Test\Unit\Service\Image;
...
class ResizerTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->resizer = $this->objectManager->create(\Creativestyle\FrontendExtension\Service\Image\Resizer::class);
