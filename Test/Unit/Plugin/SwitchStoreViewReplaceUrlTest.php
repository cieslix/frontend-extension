...
class SwitchStoreViewReplaceUrlTest extends \PHPUnit\Framework\TestCase
{
    ...
    /**
     * @var \Creativestyle\FrontendExtension\Plugin\SwitchStoreViewReplaceUrl
     */
    protected $plugin;
    ...
    /**
     * @var \Creativestyle\FrontendExtension\Service\Store\UrlGenerator|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    public function setUp()
    {
        ...
        $this->urlGeneratorDouble = $this->getMockBuilder(\Creativestyle\FrontendExtension\Service\Store\UrlGenerator::class)
            ->disableOriginalConstructor()
            ->getMock();
        ...
        $this->plugin = $this->objectManager->create(
            \Creativestyle\FrontendExtension\Plugin\SwitchStoreViewReplaceUrl::class,
            [
