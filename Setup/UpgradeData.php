...
namespace Creativestyle\FrontendExtension\Setup;
        ...
        if (!$this->eavSetup->getAttributeId(\Magento\Catalog\Model\Category::ENTITY, 'category_icon')) {
            $this->eavSetup->addAttribute(
                ...
                [
                    'type' => 'varchar',
                    'label' => 'Category Icon',
                    'backend' => 'Creativestyle\FrontendExtension\Model\Category\Attribute\Backend\Icon',
                    'input' => 'image',
                    'visible' => true,
                    'required' => false,
                    'sort_order' => 35,
    ...
    protected function upgradeToVersion007()
    {
        ...
        $this->eavSetup->addAttribute(
            ...
            [
                'type' => 'varchar',
                'label' => 'Image',
                'backend' => 'Creativestyle\FrontendExtension\Model\Category\Attribute\Backend\ImageTeaser',
                'input' => 'image',
                'visible' => true,
                'required' => false,
                'sort_order' => 10,
        ...
        if (!$this->eavSetup->getAttributeId(\Magento\Catalog\Model\Category::ENTITY, 'category_view')) {
            $this->eavSetup->addAttribute(
                ...
                [
                    ...
                    'required' => false,
                    'sort_order' => 130,
                    'source' => 'Creativestyle\FrontendExtension\Model\Category\Attribute\Source\CategoryDisplay',
                    'global' => \Magento\Eav\Model\Entity\Attribute\ScopedAttributeInterface::SCOPE_STORE,
                    'group' => 'Display Settings'
