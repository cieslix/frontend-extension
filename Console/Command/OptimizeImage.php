...
namespace Creativestyle\FrontendExtension\Console\Command;
...
class OptimizeImage extends \Symfony\Component\Console\Command\Command
{
    ...
    /**
     * @var \Creativestyle\FrontendExtension\Service\Image\OptimizerFactory
     */
    private $optimizerFactory;

    public function __construct(\Creativestyle\FrontendExtension\Service\Image\OptimizerFactory $optimizerFactory)
    {
        parent::__construct();
