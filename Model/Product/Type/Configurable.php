...
namespace Creativestyle\FrontendExtension\Model\Product\Type;
...
class Configurable extends \Magento\ConfigurableProduct\Model\Product\Type\Configurable
{
    ...
    protected function optimizedGetSalableUsedProducts(\Magento\Catalog\Model\Product $product, $requiredAttributeIds = null) {
        ...
        /** @var \Creativestyle\FrontendExtension\Helper\Product\Stock $stockHelper */
        $stockHelper = \Magento\Framework\App\ObjectManager::getInstance()->get('\Creativestyle\FrontendExtension\Helper\Product\Stock');
